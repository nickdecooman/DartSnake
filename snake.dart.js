...
$$.CanvasRenderingContext2D = {"": "CanvasRenderingContext;fillStyle},strokeStyle}",
...
_PeriodicZoneTimer: {"": "Object;_zone<,_liblib1$_callback,_timer,_isDone",
  _liblib1$_callback$1: function(arg0) {
    return this._liblib1$_callback.call$1(arg0);
  },
...
initTimer_moveSnake: {"": "Closure;",
  call$1: function(timer) {
    var hasMoved = true;
    switch ($.snakeDirection) {
      case $.Direction_1:
        hasMoved = $.snake.moveRight$0();
        break;
      case $.Direction_0:
        hasMoved = $.snake.moveLeft$0();
        break;
      case $.Direction_2:
        hasMoved = $.snake.moveUp$0();
        break;
      case $.Direction_3:
        hasMoved = $.snake.moveDown$0();
        break;
    }
    if (!hasMoved)
      timer.cancel$0();
...
initKeyBoardListener_processKeyEvent: {"": "Closure;",
  call$2: function(direction, opposite) {
    if (!$.$eq($.snakeDirection, opposite))
      $.snakeDirection = direction;
  }
},

initKeyBoardListener_keyboardListener: {"": "Closure;processKeyEvent_0",
  call$1: function($event) {
    if (typeof $event === "object" && $event !== null && !!$.getInterceptor($event).$isKeyboardEvent)
      switch ($event.keyCode) {
        case 38:
          this.processKeyEvent_0.call$2($.Direction_2, $.Direction_3);
          break;
        case 40:
          this.processKeyEvent_0.call$2($.Direction_3, $.Direction_2);
          break;
        case 37:
          this.processKeyEvent_0.call$2($.Direction_0, $.Direction_1);
          break;
        case 39:
          this.processKeyEvent_0.call$2($.Direction_1, $.Direction_0);
          break;
      }
  }
},
...
Snake: {"": "Object;queue",
  checkCollision$1: function(head) {
    var t1;
    for (t1 = this.queue, t1 = new $._ListQueueIterator(t1, t1._tail, t1._modificationCount, t1._head, null); t1.moveNext$0();)
      if (t1._liblib$_current.equals$1(head))
        return true;
    return false;
  },
  verifyNewHead$2: function(wallBeingHit, calculateNewHead) {
    var t1, t2, t3, t4, oldHead, newHead, hasNotCollided;
    t1 = this.queue;
    t2 = t1._head;
    t3 = t1._tail;
    if (t2 === t3)
    ...
    if (t3 < 0 || t3 >= t4)
      throw $.ioore(t3);
    oldHead = t2[t3];
    if (wallBeingHit.call$1(oldHead) === true)
      return false;
    newHead = calculateNewHead.call$1(oldHead);
    hasNotCollided = !this.checkCollision$1(newHead);
    if (hasNotCollided) {
      newHead.paint$1("green");
      t1._add$1(newHead);
      if (!newHead.equals$1($.fruit))
        $.clear$0$ax(t1.removeFirst$0());
      else
        $.generateFruit();
    }
  ...
  moveRight$0: function() {
    return this.verifyNewHead$2(new $.Snake_moveRight_closure(), new $.Snake_moveRight_closure0());
  },
  moveLeft$0: function() {
    return this.verifyNewHead$2(new $.Snake_moveLeft_closure(), new $.Snake_moveLeft_closure0());
  },
  moveUp$0: function() {
    return this.verifyNewHead$2(new $.Snake_moveUp_closure(), new $.Snake_moveUp_closure0());
  },
  moveDown$0: function() {
...
Snake_moveRight_closure: {"": "Closure;",
  call$1: function(head) {
    return $.$eq(head.get$xpos(), 39);
  }
},

Snake_moveRight_closure0: {"": "Closure;",
  call$1: function(oldHead) {
    var newXpos, newYpos, t1;
    newXpos = $.$add$ns(oldHead.get$xpos(), 1);
    newYpos = oldHead.get$ypos();
    t1 = new $.Tile(null, null);
    t1.xpos = newXpos;
    t1.ypos = newYpos;
    return t1;
  }
...
Snake_moveLeft_closure: {"": "Closure;",
  call$1: function(head) {
    return $.$eq(head.get$xpos(), 0);
  }
},

Snake_moveLeft_closure0: {"": "Closure;",
  call$1: function(oldHead) {
    var newXpos, newYpos, t1;
    newXpos = $.$sub$n(oldHead.get$xpos(), 1);
    newYpos = oldHead.get$ypos();
    t1 = new $.Tile(null, null);
    t1.xpos = newXpos;
    t1.ypos = newYpos;
...
Snake_moveUp_closure: {"": "Closure;",
  call$1: function(head) {
    return $.$eq(head.get$ypos(), 0);
  }
},

Snake_moveUp_closure0: {"": "Closure;",
  call$1: function(oldHead) {
    var newXpos, newYpos, t1;
    newXpos = oldHead.get$xpos();
    newYpos = $.$sub$n(oldHead.get$ypos(), 1);
    t1 = new $.Tile(null, null);
    t1.xpos = newXpos;
    t1.ypos = newYpos;
    return t1;
...
Snake_moveDown_closure: {"": "Closure;",
  call$1: function(head) {
    return $.$eq(head.get$ypos(), 39);
  }
},

Snake_moveDown_closure0: {"": "Closure;",
  call$1: function(oldHead) {
    var newXpos, newYpos, t1;
    newXpos = oldHead.get$xpos();
    newYpos = $.$add$ns(oldHead.get$ypos(), 1);
    t1 = new $.Tile(null, null);
    t1.xpos = newXpos;
    t1.ypos = newYpos;
    return t1;
...
Tile: {"": "Object;xpos<,ypos<",
  equals$1: function(obj) {
    if (typeof obj === "object" && obj !== null && !!$.getInterceptor(obj).$isTile)
      return $.$eq(obj.xpos, this.xpos) && $.$eq(obj.ypos, this.ypos);
    return false;
  },
  paint$1: function(color) {
    var t1, t2, t3;
    $.set$fillStyle$x($.get$ctx(), color);
    t1 = $.get$ctx();
    t2 = this.xpos;
    if (typeof t2 !== "number")
      return this.paint$1$bailout(1, t1, t2);
    t2 *= 15;
    t3 = this.ypos;
    if (typeof t3 !== "number")
      return this.paint$1$bailout(2, t1, t2, t3);
    $.fillRect$4$x(t1, t2, t3 * 15, 15, 15);
    $.set$strokeStyle$x($.get$ctx(), "white");
    t3 = $.get$ctx();
    t2 = this.xpos;
    if (typeof t2 !== "number")
      return this.paint$1$bailout(3, 0, t2, t3);
    t2 *= 15;
    t1 = this.ypos;
    if (typeof t1 !== "number")
      return this.paint$1$bailout(4, t1, t2, t3);
    $.strokeRect$4$x(t3, t2, t1 * 15, 15, 15);
  },
  paint$1$bailout: function(state0, t1, t2, t3) {
    switch (state0) {
      case 0:
        $.set$fillStyle$x($.get$ctx(), color);
        t1 = $.get$ctx();
      ...
      case 2:
        state0 = 0;
        $.fillRect$4$x(t1, t2, $.$mul$n(t3, 15), 15, 15);
        $.set$strokeStyle$x($.get$ctx(), "white");
        t3 = $.get$ctx();
        t2 = this.xpos;
      case 3:
      ...
      case 4:
        state0 = 0;
        $.strokeRect$4$x(t3, t2, $.$mul$n(t1, 15), 15, 15);
    }
  },
  clear$0: function(_) {
    $.set$fillStyle$x($.get$ctx(), "#EEE");
    $.fillRect$4$x($.get$ctx(), $.$sub$n($.$mul$n(this.xpos, 15), 1), $.$sub$n($.$mul$n(this.ypos, 15), 1), 17, 17);
  },
  $isTile: true
},
...
main: function() {
  $.set$width$x($.get$canvas(), 600);
  $.set$height$x($.get$canvas(), 600);
  $.set$fillStyle$x($.get$ctx(), "#EEE");
  $.fillRect$4$x($.get$ctx(), 0, 0, 600, 600);
  $.snake = $.Snake$(6);
  $.snakeDirection = $.Direction_3;
  $.initTimer();
...
initTimer: function() {
  $.timer = $.get$_Zone__current().createPeriodicTimer$2($.Duration_100000, new $.initTimer_moveSnake());
},

initKeyBoardListener: function() {
  var t1, t2;
  t1 = new $._EventStream(window, $.EventStreamProvider_keydown._eventType, false);
  t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.initKeyBoardListener_keyboardListener(new $.initKeyBoardListener_processKeyEvent()), t1._useCapture);
  t2 = t1._onData;
...
Snake$: function(initSize) {
  var t1 = new $.Snake($.ListQueue$(null));
  t1.Snake$1(initSize);
  return t1;
}}],
]);
...
$.Direction_1 = new $.Direction(1);
$.Direction_0 = new $.Direction(0);
$.Direction_3 = new $.Direction(3);
$.Direction_2 = new $.Direction(2);
